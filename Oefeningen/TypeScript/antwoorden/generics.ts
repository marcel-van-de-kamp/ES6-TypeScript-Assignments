...
////--> Above class should always store objects of the one type
////--> Write a new class 'IsGeneric' that uses generics to force this behavior
class IsGeneric<T>{
  private arr: T[] = [];
