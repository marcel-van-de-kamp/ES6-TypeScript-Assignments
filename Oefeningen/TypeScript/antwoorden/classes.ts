...
////////////////////////////////////////////////////////////////////////////////
class Animal {
  public canSeeInTheDark: boolean;
  
  constructor(private name:string, private animalKind: AnimalKind) {
    
    this.canSeeInTheDark = animalKind === AnimalKind.cat;
  }
...
////--> Create an instance of the AnimalClass, call the see method and print its result
var animal = new Animal('Marcel', AnimalKind.dog);
console.log(animal.see());
