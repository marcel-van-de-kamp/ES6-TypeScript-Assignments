...
let strLength: number = (<string>someVarDefinedLater).length; // OR
let strLength1: number = (someVarDefinedLater as string).length;

let test = (someVarDefinedLater as string);
